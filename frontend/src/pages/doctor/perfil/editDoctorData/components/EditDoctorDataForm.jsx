...
import { UpdateDoctorPersonalData } from '../../../../../services/Doctor/UpdateDoctorPersonalData'
...
function EditDataForm() {
  ...
  const updateDataHandler = async (event) => {
    ...
    const response = await UpdateDoctorPersonalData(userUpdate, user)
      ...
      <div id="personal-data-container" className="flex-column">
        ...
        >
          <div className="flex-column">
            <span className="personalDataTitle">Nombre</span>
            <input
